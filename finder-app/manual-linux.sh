...
cp -a ${SYSROOT}/lib64/libm-2.31.so ${OUTDIR}/rootfs/lib64 #libm-2.31.so
cp -a ${SYSROOT}/lib64/libc.so.6 ${OUTDIR}/rootfs/lib64 #libc.so.6
cp -a ${SYSROOT}/lib64/libc-2.31.so ${OUTDIR}/rootfs/lib64 #libc.so.6
cp -a ${SYSROOT}/lib64/libresolv.so.2 ${OUTDIR}/rootfs/lib64 #libresolv.so.2 
cp -a ${SYSROOT}/lib64/libresolv-2.31.so ${OUTDIR}/rootfs/lib64 #libresolv-2.31.so
